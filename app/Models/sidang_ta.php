...
class sidang_ta extends Model
{
    use HasFactory;
    protected $table = 'sidang_tas';
    ...
    public function sekretaris_penguji()
    {
        return $this->belongsTo(dosen::class, 'sekretaris', 'id_dosen');
    }
    public function anggota1()
    {
        return $this->belongsTo(dosen::class, 'anggota_1', 'id_dosen');
    }
    public function anggota2()
    {
        return $this->belongsTo(dosen::class, 'anggota_2', 'id_dosen');
    }
