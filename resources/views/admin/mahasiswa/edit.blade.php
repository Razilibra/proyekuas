                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nim" id="nim" class="form-control @error('nim') is-invalid @enderror" value="{{ old('nim', $mahasiswa->nim) }}" placeholder="Masukkan NIM" required>
                                    @error('nim')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('id_jurusan') is-invalid @enderror" id="id_jurusan" name="id_jurusan" required>
                                        ...
                                        @foreach ($jurusan as $j)
                                            <option value="{{ $j->id_jurusan }}" {{ old('id_jurusan', $mahasiswa->id_jurusan) == $j->id_jurusan ? 'selected' : '' }}>{{ $j->nama_jurusan }}</option>
                                        @endforeach
                                    </select>
                                    @error('id_jurusan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal_daftar" id="tanggal_daftar" class="form-control @error('tanggal_daftar') is-invalid @enderror" value="{{ old('tanggal_daftar', $mahasiswa->tanggal_daftar) }}" required>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            $('#id_prodi').append('<option value="' + value.id_prodi + '">' + value.prodi + '</option>');
                        });
                    },
                    error: function(xhr) {
