        ...
        <div class="card shadow mb-4">
            ...
            <form action="{{ route('dosen.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('id_bidang') is-invalid @enderror" id="id_bidang" name="id_bidang">
                                    ...
                                    @foreach($bidangs as $bd)
                                        <option value="{{ $bd->id_bidang }}" {{ old('id_bidang') == $bd->id_bidang ? 'selected' : '' }}>
                                            {{ $bd->bidang }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('id_golongan') is-invalid @enderror" id="id_golongan" name="id_golongan">
                                    ...
                                    @foreach($golongan as $g)
                                        <option value="{{ $g->id_golongan }}" {{ old('id_golongan') == $g->id_golongan ? 'selected' : '' }}>
                                            {{ $g->nama_golongan }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('id_pangkat') is-invalid @enderror" id="id_pangkat" name="id_pangkat">
                                    ...
                                    @foreach($pangkat as $pk)
                                        <option value="{{ $pk->id_pangkat }}" {{ old('id_pangkat') == $pk->id_pangkat ? 'selected' : '' }}>
                                            {{ $pk->pangkat }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('sinta') is-invalid @enderror"
                                    id="sinta" name="sinta" value="{{ old('sinta') }}">
                                @error('sinta')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control @error('link_sinta') is-invalid @enderror"
                                    id="link_sinta" name="link_sinta" value="{{ old('link_sinta') }}">
                                @error('link_sinta')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('schoolar') is-invalid @enderror"
                                    id="schoolar" name="schoolar" value="{{ old('schoolar') }}">
                                @error('schoolar')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('dosen.index') }}" class="btn btn-secondary btn-sm">Batal</a>
                </div>
            </form>
        </div>
    </div>
